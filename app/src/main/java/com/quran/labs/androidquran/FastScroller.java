...
import com.quran.labs.androidquran.viewprovider.DefaultScrollerViewProvider;
import com.quran.labs.androidquran.viewprovider.ScrollerViewProvider;
...
public class FastScroller extends LinearLayout {
    ...
    public FastScroller(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            bubbleTextAppearance = style.getResourceId(R.styleable.fastscroll_fastscroller_fasscroll_bubbleTextAppearance, STYLE_NONE);
        } finally {
            style.recycle();
        }
    }
